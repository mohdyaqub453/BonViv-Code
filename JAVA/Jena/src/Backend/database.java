...
/*
 * In this class we query from database
 * conversion of sparql json1.1 binding to JSON manually by extracting data from binding 
 * and convert it into jsonObject and JsonArray
 * 
 *Json to java object using same json 
 */
...
//		  dataset.end() ;
//		  
//		  dataset.begin(ReadWrite.WRITE) ;                 //dataset for write 
//		  model = dataset.getDefaultModel() ;                 
//		  Model model1 = ModelFactory.createDefaultModel();    
//		  model1.read("example.jsonld") ;                  //add file in model 
//		  model.add(model1);
//		   
//		  model.commit();                             //commit files 
//		  dataset.end() ;
		 ...
		 //convert select query in jsonArray using binding
...
//book class for json object
/*
 * class for json object  getter and setter function for initialize data and extracting data
 * 
 */
class Book {
