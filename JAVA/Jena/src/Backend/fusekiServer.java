...
//@RestController
/*
 * This class contains CRUD operation for fuseki Server and create connection to to endpoints
 * we can insert ,update ,delete ,get data from fuseki server
 */
   ...
   // @GetMapping("/select")
    public  String select() {
        // In this variation, a connection is built each time.
            ...
            QueryExecution qExec = conn.query("prefix rdfs: <http://www.w3.org/2000/01/rdf-schema#> prefix owl: <http://www.w3.org/2002/07/owl#> JSON{ 'subject;':?subject , 'predicate':?predicate , 'object':?object} WHERE {?subject ?predicate ?object }");
            JsonArray results = qExec.execJson();     //results in json
            
            return results.toString();
            //results in binding json1.1
//            ResultSet rs = qExec.execJson() ;
